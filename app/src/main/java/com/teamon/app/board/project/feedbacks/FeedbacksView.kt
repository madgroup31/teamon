...
@Composable
fun DayHeaderProject(day: String)
{
    Row(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun RatingRowProject(rating: Int,
...
@Composable
fun FeedbackActionsProject(anonymousFilter: Boolean,
            ...
            DropdownMenu(
                ...
                Box(
                    ...
                    Row(
                        ...
                        if (showDate) {
                            DatePickerDialogFeedbackProject(
...
@Composable
fun FeedbacksView(actions: Actions, projectVM: ProjectViewModel)
{

    val feedbacks = projectVM.feedbacks.toList()
    ...
    if(projectVM.isWritingFeedback)
    {
        NewFeedbackDialog(
            ...
            onDismissRequest = { projectVM.toggleIsWritingFeedback() },
            projectVm = projectVM
        )
    }
    ...
    if (feedbacks.isEmpty())
    {
        Column(
            ...
            Text(
                text = "No Available Feedbacks yet",
    ...
    if (feedbacks.isEmpty())
        ...
        AnimatedGrid(
            ...
            FeedbackCard(actions = actions, feedback = it as Feedback)
        }
    */
